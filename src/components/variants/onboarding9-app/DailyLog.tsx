  ...
  return (
    <div className="min-h-screen pb-20" style={{background:"#ffffff",fontFamily:"system-ui"}}>
      <div className="px-5 pt-14">
        ...
        <button className="w-full py-3 rounded-full text-sm font-medium border-0 cursor-pointer" style={{background:"#8b5cf6",color:"#ffffff"}}>Save Log</button>
