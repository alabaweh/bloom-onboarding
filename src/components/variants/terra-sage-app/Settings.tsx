  ...
  return (
    <div className="min-h-screen pb-20" style={{background:"#f4f1ec",fontFamily:"system-ui"}}>
      <div className="px-5 pt-14">
        <h1 className="text-xl font-light tracking-widest text-center mb-1" style={{color:"#6b8f5e",fontFamily:"Georgia, serif"}}>Settings</h1>
        <div className="mb-6"/>
        <div className="space-y-3">{["Notifications","Privacy","Data export","Cycle preferences","Appearance","Language","Help center","About Sage"].map(s=>(<button key={s} className="w-full flex justify-between items-center p-4 rounded-xl text-left border-0 cursor-pointer" style={{background:"rgba(107,143,94,0.08)",border:"1px solid rgba(0,0,0,0.06)"}}><span className="text-sm" style={{color:"#2d3a28"}}>{s}</span><svg width="16" height="16" viewBox="0 0 24 24" fill="rgba(45,58,40,0.5)"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg></button>))}</div>
