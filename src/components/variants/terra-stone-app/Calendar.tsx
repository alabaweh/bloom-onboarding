  ...
  return (
    <div className="min-h-screen pb-20" style={{background:"#f0eded",fontFamily:"system-ui"}}>
      <div className="px-5 pt-14">
        <h1 className="text-xl font-light tracking-widest text-center mb-1" style={{color:"#8a7060",fontFamily:"system-ui, sans-serif"}}>January 2025</h1>
