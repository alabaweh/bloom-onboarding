  ...
  return (
    <div className="min-h-screen pb-20" style={{background:"#0a0f1a",fontFamily:"system-ui"}}>
      <div className="px-5 pt-14">
        ...
        <button className="w-full py-3 rounded-full text-sm font-medium border-0 cursor-pointer mt-2" style={{background:"#7dd3a8",color:"#0a0f1a"}}>Post Anonymously</button>
      </div>
      <Nav active="home"/>
    </div>
  );
