  ...
  return (
    <div className="min-h-screen pb-20" style={{background:"#0a0f1a",fontFamily:"system-ui"}}>
      <div className="px-5 pt-14">
        <h1 className="text-xl font-light tracking-widest mb-1" style={{color:"#7dd3a8",fontFamily:"Georgia, serif"}}>Daily Log</h1>
        ...
        <button className="w-full py-3 rounded-full text-sm font-medium border-0 cursor-pointer" style={{background:"#7dd3a8",color:"#0a0f1a"}}>Save Log</button>
