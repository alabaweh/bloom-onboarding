  ...
  return (
    <div className="min-h-screen pb-20" style={{background:"#faf6f0",fontFamily:"system-ui"}}>
      <div className="px-5 pt-14">
        <h1 className="text-xl font-light tracking-widest text-center mb-1" style={{color:"#c2956b",fontFamily:"Georgia, serif"}}>Learn</h1>
        <div className="mb-6"/>
        <div className="space-y-3">{[{title:"Understanding your phases",tag:"Cycle basics",mins:"3 min"},{title:"Nutrition by cycle phase",tag:"Wellness",mins:"5 min"},{title:"Exercise and your cycle",tag:"Fitness",mins:"4 min"},{title:"Sleep optimization tips",tag:"Recovery",mins:"3 min"}].map(a=>(<div key={a.title} className="rounded-2xl p-4" style={{background:"rgba(194,149,107,0.06)",border:"1px solid rgba(0,0,0,0.06)"}}><div className="flex items-center gap-2 mb-2"><span className="px-2 py-0.5 rounded-full text-[9px] font-medium" style={{background:"#c2956b",color:"#ffffff"}}>{a.tag}</span><span className="text-[10px] ml-auto" style={{color:"rgba(61,46,31,0.5)"}}>{a.mins}</span></div><p className="text-sm font-medium" style={{color:"#3d2e1f"}}>{a.title}</p></div>))}</div>
