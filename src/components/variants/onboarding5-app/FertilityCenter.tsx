  ...
  return (
    <div className="min-h-screen pb-20" style={{background:"#f5f0eb",fontFamily:"system-ui"}}>
      <div className="px-5 pt-14">
        <h1 className="text-xl font-light tracking-widest mb-1" style={{color:"#c07a50",fontFamily:"Georgia, serif"}}>Fertility</h1>
        ...
        {mode==="cycle"&&<div className="rounded-2xl p-4 mb-4" style={{background:"rgba(0,0,0,0.04)"}}><p className="text-[10px] tracking-wider mb-2" style={{color:"rgba(0,0,0,0.4)"}}>FERTILE WINDOW</p><p className="text-sm" style={{color:"#3c2f2f"}}>Jan 12 — Jan 16</p><p className="text-xs mt-1" style={{color:"rgba(0,0,0,0.4)"}}>Ovulation estimated: Jan 14</p></div>}
        {mode==="ttc"&&(<><div className="rounded-2xl p-4 mb-4" style={{background:"rgba(0,0,0,0.04)"}}><p className="text-[10px] tracking-wider mb-3" style={{color:"rgba(0,0,0,0.4)"}}>LH TEST LOG</p><div className="flex flex-wrap gap-2">{["Day 10","Day 11","Day 12","Day 13","Day 14"].map(d=>(<button key={d} onClick={()=>toggleLh(d)} className="px-4 py-2 rounded-full text-xs border-0 cursor-pointer" style={{background:lhResults.includes(d)?"rgba(0,0,0,0.08)":"rgba(0,0,0,0.04)",color:lhResults.includes(d)?"#c07a50":"rgba(0,0,0,0.4)"}}>{d} {lhResults.includes(d)?"+":"−"}</button>))}</div></div>
        <div className="rounded-2xl p-4 mb-4" style={{background:"rgba(0,0,0,0.04)"}}><p className="text-[10px] tracking-wider mb-2" style={{color:"rgba(0,0,0,0.4)"}}>CONCEPTION PROBABILITY</p><p className="text-3xl font-light" style={{color:"#c07a50"}}>32%</p></div></>)}
        {mode==="pregnancy"&&<div className="rounded-2xl p-4 mb-4" style={{background:"rgba(0,0,0,0.04)"}}><p className="text-[10px] tracking-wider mb-2" style={{color:"rgba(0,0,0,0.4)"}}>NEXT APPOINTMENT</p><p className="text-sm font-medium" style={{color:"#3c2f2f"}}>Week 12 Ultrasound</p><p className="text-xs mt-1" style={{color:"rgba(0,0,0,0.4)"}}>NT scan and blood work</p></div>}
