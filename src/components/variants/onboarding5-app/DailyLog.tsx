  ...
  return (
    <div className="min-h-screen pb-20" style={{background:"#f5f0eb",fontFamily:"system-ui"}}>
      <div className="px-5 pt-14">
        ...
        <button className="w-full py-3 rounded-full text-sm font-medium border-0 cursor-pointer" style={{background:"#c07a50",color:"#f5f0eb"}}>Save Log</button>
