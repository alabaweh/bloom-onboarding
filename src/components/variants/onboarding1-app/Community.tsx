  ...
  return (
    <div className="min-h-screen pb-20" style={{background:"#0c0a1d",fontFamily:"system-ui"}}>
      <div className="px-5 pt-14">
        ...
        <button className="w-full py-3 rounded-full text-sm font-medium border-0 cursor-pointer mt-2" style={{background:"#f5d882",color:"#0c0a1d"}}>Post Anonymously</button>
      </div>
      <Nav active="home"/>
    </div>
  );
