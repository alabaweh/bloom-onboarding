  ...
  return (
    <div className="min-h-screen pb-20" style={{background:"#1a1210",fontFamily:"system-ui"}}>
      <div className="px-5 pt-14">
        <h1 className="text-xl font-light tracking-widest text-center mb-1" style={{color:"#d4663a",fontFamily:"Georgia, serif"}}>Learn</h1>
        <div className="mb-6"/>
        <div className="space-y-3">{[{title:"Understanding your phases",tag:"Cycle basics",mins:"3 min"},{title:"Nutrition by cycle phase",tag:"Wellness",mins:"5 min"},{title:"Exercise and your cycle",tag:"Fitness",mins:"4 min"},{title:"Sleep optimization tips",tag:"Recovery",mins:"3 min"}].map(a=>(<div key={a.title} className="rounded-2xl p-4" style={{background:"rgba(212,102,58,0.08)",border:"1px solid rgba(255,255,255,0.06)"}}><div className="flex items-center gap-2 mb-2"><span className="px-2 py-0.5 rounded-full text-[9px] font-medium" style={{background:"#d4663a",color:"#1a1210"}}>{a.tag}</span><span className="text-[10px] ml-auto" style={{color:"rgba(245,230,220,0.4)"}}>{a.mins}</span></div><p className="text-sm font-medium" style={{color:"#f5e6dc"}}>{a.title}</p></div>))}</div>
