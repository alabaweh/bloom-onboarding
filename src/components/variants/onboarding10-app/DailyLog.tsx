  ...
  return (
    <div className="min-h-screen pb-20" style={{background:"#faf5eb",fontFamily:"system-ui"}}>
      <div className="px-5 pt-14">
        ...
        <button className="w-full py-3 rounded-full text-sm font-medium border-0 cursor-pointer" style={{background:"#e8735a",color:"#faf5eb"}}>Save Log</button>
