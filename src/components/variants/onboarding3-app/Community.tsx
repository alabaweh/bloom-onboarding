  ...
  return (
    <div className="min-h-screen pb-20" style={{background:"#fff8f0",fontFamily:"system-ui"}}>
      <div className="px-5 pt-14">
        ...
        <button className="w-full py-3 rounded-full text-sm font-medium border-0 cursor-pointer mt-2" style={{background:"#d4a060",color:"#fff8f0"}}>Post Anonymously</button>
      </div>
      <Nav active="home"/>
    </div>
  );
