  ...
  return (
    <div className="min-h-screen pb-20" style={{background:"#f8fafc",fontFamily:"system-ui"}}>
      <div className="px-5 pt-14">
        <h1 className="text-xl font-light tracking-widest text-center mb-1" style={{color:"#0ea5e9",fontFamily:"system-ui"}}>January 2025</h1>
