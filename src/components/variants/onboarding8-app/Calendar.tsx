  ...
  return (
    <div className="min-h-screen pb-20" style={{background:"#fefefe",fontFamily:"system-ui"}}>
      <div className="px-5 pt-14">
        <h1 className="text-xl font-light tracking-widest text-center mb-1" style={{color:"#f9a8c9",fontFamily:"Georgia, serif"}}>January 2025</h1>
