  ...
  return (
    <div className="min-h-screen pb-20" style={{background:"#2a1f14",fontFamily:"system-ui"}}>
      <div className="px-5 pt-14">
        <h1 className="text-xl font-light tracking-widest text-center mb-1" style={{color:"#d4a24e",fontFamily:"Georgia, serif"}}>Daily Log</h1>
