  ...
  return (
    <div className="min-h-screen pb-20" style={{background:"#2a1f14",fontFamily:"system-ui"}}>
      <div className="px-5 pt-14">
        <h1 className="text-xl font-light tracking-widest text-center mb-1" style={{color:"#d4a24e",fontFamily:"Georgia, serif"}}>Fertility</h1>
        <div className="mb-6"/>
        <div className="rounded-2xl p-5 mb-4 text-center" style={{background:"rgba(212,162,78,0.08)",border:"1px solid rgba(255,255,255,0.06)"}}><p className="text-xs" style={{color:"rgba(240,228,208,0.4)"}}>Fertility score</p><p className="text-4xl font-light" style={{color:"#d4a24e",fontFamily:"Georgia, serif"}}>78%</p><p className="text-xs mt-1" style={{color:"rgba(240,228,208,0.4)"}}>Based on current cycle data</p></div><div className="space-y-3">{[{l:"Ovulation tracking",v:"Active"},{l:"BBT logging",v:"7 days"},{l:"Cervical mucus",v:"Egg-white"},{l:"LH test",v:"Positive"}].map(s=>(<div key={s.l} className="flex justify-between items-center p-3 rounded-xl" style={{background:"rgba(212,162,78,0.08)",border:"1px solid rgba(255,255,255,0.06)"}}><span className="text-xs" style={{color:"#f0e4d0"}}>{s.l}</span><span className="text-xs font-medium" style={{color:"#d4a24e"}}>{s.v}</span></div>))}</div>
